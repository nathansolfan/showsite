    ...
    <nav class="w-full py-6 bg-white shadow">
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="block lg:hidden">
                ...
                class="flex items-center px-3 py-2 border rounded text-gray-800 border-gray-400 hover:text-gray-600 hover:border-gray-600">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                <div class="lg:flex-grow">
                    ...
                    <a href="/tropicalBeauty" class="block lg:inline-block text-gray-800 hover:text-gray-600 mx-4">Beauty</a>
