<x-layout>
    <div
        class="relative h-[400px] md:h-[700px] lg:h-[830px] flex items-center justify-center overflow-hidden bg-cover bg-center"
        ...
        <div class="relative z-10 text-center px-6 max-w-4xl">
            <h1 class="text-4xl sm:text-5xl text-white md:text-7xl font-extrabold leading-tight" data-aos="fade-down"
                data-aos-duration="800">
                Nathan Ferreira
                <br>
                <span id="typewriter-text" class="text-blue-400"></span>
            </h1>
            <p class="text-lg sm:text-xl mt-4 text-white max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="400"
               data-aos-duration="800">
    ...
    <section id="projects" class="mt-12 sm:mt-20">
        <div class="container mx-auto px-4 mb-8 sm:mb-12">
            ...
            <p class="text-base sm:text-xl text-gray-600 text-center mt-3 sm:mt-4 max-w-3xl mx-auto" data-aos="fade-up"
               data-aos-delay="200">
