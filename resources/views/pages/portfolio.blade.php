...
<head>
  ...
  <title>Solar System Animation with Clickable Planets</title>
  <style>
    /* Basic body styling */
    body {
    ...
    .planet {
      ...
      border-radius: 50%;
      cursor: pointer;
      /* Adding a hover effect: scale up slightly */
    ...
    .planet1 {
      ...
      background-color: #BDB76B; /* Mercury-like */
    }
    .planet2 {
      animation: orbit2 6s linear infinite;
      background-color: #DAA520; /* Venus-like */
    }
    .planet3 {
      animation: orbit3 8s linear infinite;
      background-color: #1E90FF; /* Earth-like */
    }
    .planet4 {
      animation: orbit4 10s linear infinite;
      background-color: #FF4500; /* Mars-like */
    }
    .planet5 {
      animation: orbit5 12s linear infinite;
      background-color: #FFD700; /* Jupiter-like */
    }
    .planet6 {
      animation: orbit6 14s linear infinite;
      background-color: #87CEFA; /* Saturn-like */
    }
    .planet7 {
      animation: orbit7 16s linear infinite;
      background-color: #66CDAA; /* Uranus-like */
    }
    .planet8 {
      animation: orbit8 18s linear infinite;
      background-color: #4169E1; /* Neptune-like */
    }
