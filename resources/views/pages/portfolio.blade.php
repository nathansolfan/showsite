...
<head>
    ...
    <style>
        ...
        /* Wrapper for setting the 3D perspective */
        .solar-system-wrapper {
            perspective: 1000px;
            /* Adjust this value to change the depth effect */
        }
        ...
        .solar-system {
            ...
            /* Rotate the solar system by 45 degrees */
...
<body>
    ...
    <style>
        /* Wrap the solar system in a container with perspective */
        .solar-system-wrapper {
            perspective: 1000px;
        }
    </style>

    <!-- Wrap your solar system in the wrapper -->
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // Apply the 45-degree tilt to the solar system
