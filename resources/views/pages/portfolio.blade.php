    ...
    <div class="bg-gradient-to-b from-green-100 to-white min-h-screen py-16 px-6">
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-10 md:space-y-0">
            ...
            <div class="max-w-lg text-center md:text-left">
                ...
                <a href="{{ url('/shop') }}"
                    class="bg-black text-white px-6 py-3 rounded-md shadow-md hover:bg-gray-800 transition">
                    Shop Now
                </a>
            </div>
            ...
            <div class="w-full md:w-1/2 flex justify-center">
                <img src="{{ asset('images/bgimagecake.jpg') }}" alt="Cake Image"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <div class="flex justify-center mb-4">
                        {{-- SVG T-Shirt --}}
                        <svg width="100" height="100" viewBox="0 0 24 24" fill="#F59E0B"
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <div class="flex justify-center mb-4">
                        {{-- SVG T-Shirt --}}
                        <svg width="100" height="100" viewBox="0 0 24 24" fill="#374151"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2L15.09 4H20V10H18V22H6V10H4V4H9L12 2Z" stroke="black" stroke-width="1.5" />
                        </svg>
                    </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <div class="flex justify-center mb-4">
                        {{-- SVG T-Shirt --}}
                        <svg width="100" height="100" viewBox="0 0 24 24" fill="#DC2626"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2L15.09 4H20V10H18V22H6V10H4V4H9L12 2Z" stroke="black" stroke-width="1.5" />
                        </svg>
                    </div>
