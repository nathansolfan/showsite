...
<div class="w-full py-8 px-4 overflow-hidden">
  ...
  <div class="max-w-4xl mx-auto">
    <!-- Glass Card -->
    <div class="relative overflow-hidden bg-gradient-to-br from-indigo-500 to-green-600 rounded-2xl shadow-xl">
      ...
      <div class="p-5">
        <!-- Description -->
        <div class="mb-6 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
