<template>
    <div class="p-4 text-white">
        <textarea v-model="input" class="w-full h-40 bg-gray-800 p-3 rounded" placeholder="Type your text"></textarea>

        <button @click="analyze" class="mt-3 bg-blue-600 px-4 py-2 rounded">Analyze</button>
